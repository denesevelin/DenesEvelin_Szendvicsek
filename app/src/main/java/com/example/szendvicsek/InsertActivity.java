...
public class InsertActivity extends AppCompatActivity {
    ...
    private EditText editTextNev, editTextLeiras, editTextElkeszites, editTextAr;
    ...
    public void adatRogzites(){
        ...
        String elkeszites = editTextElkeszites.getText().toString().trim();
        String ar = editTextAr.getText().toString().trim();
        ...
        if(elkeszites.isEmpty()){
            Toast.makeText(this, "Elkészítés megadása kötelező", Toast.LENGTH_SHORT).show();
            editTextElkeszites.setError("Elkészítés megadása kötelező");
            return;
        }
        if(ar.isEmpty()){
            Toast.makeText(this, "Ár megadása kötelező", Toast.LENGTH_SHORT).show();
            editTextAr.setError("Ár megadása kötelező");
            return;
        }

        if(adatbazis.adatRogzites(nev,leiras,elkeszites, ar)){
    ...
    public void init(){
        ...
        editTextElkeszites = findViewById(R.id.editTextElkeszites);
